 ...
 * So the synthesis is opt-in via [Direct3d11] synthesizeHemisphericLight, off by default, same
 * rule as the other inherited compensations: the data renders as authored unless a knob says
 * otherwise.
 */
